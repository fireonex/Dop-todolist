...
function App() {
    ...
    function changeStatus(todolistId: string, taskId: string, newIsDone: boolean) {
        setTasks({
            ...tasks, [todolistId]: {
                ...tasks[todolistId], data: tasks[todolistId].data.map(
        ...
        // setTasks({
        //     ...tasks,
        //     [todolistId]: tasks[todolistId].data.map(el => el.id === taskId ? {...el, isDone: newIsDone} : el)
        // })
    }
